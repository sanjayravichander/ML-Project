...
class DataIngestion:
    def __init__(self):
        self.ingestion_config=DataIngestionConfig()# Creates an instance of the DataIngestionConfig class, storing it as an attribute ingestion_config. This will be used to access the file paths defined earlier.
